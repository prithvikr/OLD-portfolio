...
const Technologies = () => {
  return (
    <section id="technologies" className="py-10">
      <div className="container m-auto pl-20 pr-25">
        <h2 className="text-4xl font-bold uppercase text-center text-[#001b5e] ">
          Technologies
        </h2>
        <div className="mt-14">
          <div>
          ...
          <div className="mt-8">
            <div className="flex justify-between items-center">
              <h2 className="font-semibold">ReactJs NodeJs</h2>
              <p className="text-gray-500">Advanced</p>
            </div>
          ...
          <div className="mt-8">
            <div className="flex justify-between items-center">
              <h2 className="font-semibold">Responive Web Design</h2>
              <p className="text-gray-500">Advanced</p>
            </div>
